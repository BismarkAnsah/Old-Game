...
export default class Royal5Utils {
    numberBtns = {
        row1: document.querySelectorAll('.btns-row1'),
        row2: document.querySelectorAll('.btns-row2'),
        row3: document.querySelectorAll('.btns-row3'),
        row4: document.querySelectorAll('.btns-row4'),
        row5: document.querySelectorAll('.btns-row5')
    };
    ...
    {
            let location = element.classList.contains('row1') ? this.numsClicked.row1 : this.numsClicked.row2;
