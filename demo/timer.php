...
<body>
	<div id="Web_1920__1">
		...
		<div id="Group_2">
			...
			<div class="num-group row1">
				<?php
				for ($x = 0; $x < 10; $x++) {
				?>
					<button class="num hover-shape row1 btn-circle"><?= $x ?></button>
				<?php
				}
				?>
			</div>

			<div class="num-controls row1">
				<button id="All" class="hover-shape btn-rec">All</button>
				<button id="Big" class="hover-shape btn-rec">Big</button>
				<button id="Small" class="hover-shape btn-rec">Small</button>
				<button id="Odd" class="hover-shape btn-rec">Odd</button>
				<button id="Even" class="hover-shape btn-rec">Even</button>
				<button id="Clear" class="hover-shape btn-rec">Clear</button>
			</div>
			<div class="period-box">
				<label for="">Period</label>
				<select class="period" name="" placeholder="20221221413">
