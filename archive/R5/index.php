...
<head>
	...
	<style id="applicationStylesheet" type="text/css">
		* {
		...
		.show-balance .user-balance, .show-balance .eye{
			display: inline !important;

		}

		.show-balance .asterisks, .show-balance .eye-slash{
				...
				<div class="work-area" style="border: px solid black;">
					...
					<div class="allRows num-btn-controls game-interface" style="display: none;">
						<div class="row1  interface-item">
							<div class="col num-group row1" data-points-to="row1">
							...
							<div class="col num-controls row1" data-points-to="row1">
						...
						<div class="row2  interface-item">
							<div class="col num-group row2" data-points-to="row2">
							...
							<div class="col num-controls row2" data-points-to="row2">
								<button id="All" class="btn-c hover-shape btn-rec all-btn">All</button>
								<button id="Big" class="btn-c hover-shape btn-rec big-btn">Big</button>
								<button id="Small" class="btn-c hover-shape btn-rec small-btn">
									Small
						...
						<div class="row3  interface-item">
							<div class="col num-group row3" data-points-to="row3">
								<label for="">3rd</label>
								<?php
								for ($x = 0; $x < 10; $x++) {
								?>
							...
							<div class="col num-controls row3" data-points-to="row3">
								<button id="All" class="btn-c hover-shape btn-rec all-btn">All</button>
								<button id="Big" class="btn-c hover-shape btn-rec big-btn">Big</button>
								<button id="Small" class="btn-c hover-shape btn-rec small-btn">
									Small
						...
						<div class="row4  interface-item">
							<div class="col num-group row4" data-points-to="row4">
								<label for="">4th</label>
								<?php
								for ($x = 0; $x < 10; $x++) {
								?>
							...
							<div class="col num-controls row4" data-points-to="row4">
								<button id="All" class="btn-c hover-shape btn-rec all-btn">All</button>
								<button id="Big" class="btn-c hover-shape btn-rec big-btn">Big</button>
								<button id="Small" class="btn-c hover-shape btn-rec small-btn">
									Small
						...
						<div class="row5  interface-item">
							...
							<div class="col num-controls row5" data-points-to="row5">
								<button id="All" class="btn-c hover-shape btn-rec all-btn">All</button>
								<button id="Big" class="btn-c hover-shape btn-rec big-btn">Big</button>
								<button id="Small" class="btn-c hover-shape btn-rec small-btn">
									Small
					...
					<div class="row">
						...
						<div class="multiplier-bet-box">
							<div class="multiplier-input-box">
								...
								<input class="multiplier-input" type="text" name="" value="1" placeholder="multiplier" />
