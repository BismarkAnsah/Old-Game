	...
	<div id="Web_1920__1">
		...
		<div id="Group_2">
			...
			<div class="num-group row1">
				...
				for ($x = 0; $x < 10; $x++) {
				?>
					<button class="btn-c num hover-shape row1 btn-circle"><?= $x ?></button>
				<?php
				}
				?>
			</div>
			...
			<div class="num-controls row1">
				<button id="All" class="btn-c hover-shape btn-rec">All</button>
				<button id="Big" class="btn-c hover-shape btn-rec">Big</button>
				<button id="Small" class="btn-c hover-shape btn-rec">Small</button>
				<button id="Odd" class="btn-c hover-shape btn-rec">Odd</button>
